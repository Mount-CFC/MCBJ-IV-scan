% 统计一下那天晚上记录的0.1V的芯片的PSD，跑了两组
% 读取logG的数值，在data的第5 列
clc
clear
close all
tic
...
PlotSelect = false;     %If it is True, polt the raw .TDMS files
...
if num_files == 1
    ...
    for n = 1:num_files
        test=TDMS_readTDMSFile(filename1{n});
        data_temp=test.data{1,5}; %Conductance is the 4th column
